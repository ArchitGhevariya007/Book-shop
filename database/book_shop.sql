...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3111343951ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=book_shop&table=user_login">`book_shop`.`user_login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test1&table=trial">`test1`.`trial`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=employeetb&table=empyeetb">`employeetb`.`empyeetb`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=employeetb&table=Empyeetb">`employeetb`.`Empyeetb`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="415f36445f68216c412d464952557a5d">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="book_shop" targettable="user_login">
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE `book_shop`.`user_login` ( `email` VARCHAR(30) NOT NULL ,  `password` VARCHAR(8) NOT NULL ,    PRIMARY KEY  (`email`(30))) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="book_shop" targettable="user_login">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO `user_login` (`email`, `password`) VALUES (&#039;archit@gmail.com&#039;, &#039;Archit123&#039;);</span>
                        </div>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `user_login`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="book_shop" targettable="user_login">
                            <div class="action_content">
